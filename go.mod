...
require (
	github.com/Plaud-AI/plaud-go-scaffold v0.1.1
...
require (
	...
	github.com/Plaud-AI/plaud-library-go v0.0.15 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/appconfigdata v1.19.6 // indirect
